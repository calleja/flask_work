...
class Dialogue(object):
    ...
    def engageUser(self, menuSelection):
    ...
    def prepareTrade(self):
        ...
        #refactor this function to return the subsection of tickers every time a call is made from the controller2 module
            agg_dic={}            
            #dictionary of trade stats to send over to the tradeClass
            self.rm=retrieveMarkets.RetrieveMarkets()
